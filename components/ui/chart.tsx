...
// recharts 3 收窄了 Tooltip/Legend 的 props 类型，这里放宽为运行时实际存在的字段
...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  Omit<React.ComponentProps<typeof RechartsPrimitive.Tooltip>, "ref" | "payload" | "label" | "labelFormatter" | "formatter"> &
    React.ComponentProps<"div"> & {
      hideLabel?: boolean
...
>(
  (
    ...
    const items = React.useMemo(
      () => (payload || []) as unknown as TooltipPayloadItem[],
      [payload]
    )
